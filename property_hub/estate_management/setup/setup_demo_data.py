...
OWNERS = [
	{
		"owner_name": "Ahmed Al-Rashidi",
		"phone": "+965-9911-2233",
		"email": "ahmed.rashidi@demo.com",
		"nationality": "Kuwaiti",
		"civil_id": "287061234567",
		"status": "Active",
	},
	{
		"owner_name": "Sara Al-Mutairi",
		"phone": "+965-9922-3344",
		"email": "sara.mutairi@demo.com",
		"nationality": "Kuwaiti",
		"civil_id": "291071234568",
		"status": "Active",
	},
	{
		"owner_name": "Gulf Properties LLC",
		"phone": "+965-2234-5566",
		"email": "info@gulfproperties.demo",
		"nationality": "Company",
		"civil_id": "",
		"status": "Active",
	},
...
PROPERTIES = [
	{
		"property_name": "Al-Noor Tower",
		"property_code": "ANT-001",
		"owner_index": 0,
		"property_type": "Residential",
		"address": "Block 5, Al-Salmiya",
		"city": "Salmiya",
		"final_status": "Occupied",
	},
	{
		"property_name": "Gulf Commercial Center",
		"property_code": "GCC-001",
		"owner_index": 2,
		"property_type": "Commercial",
		"address": "Abdullah Al-Salem, Block 3",
		"city": "Kuwait City",
		"final_status": "Occupied",
	},
	{
		"property_name": "Marina Residences",
		"property_code": "MR-001",
		"owner_index": 1,
		"property_type": "Residential",
		"address": "Marina District, Block 2",
		"city": "Salmiya",
		"final_status": "Occupied",
	},
	{
		"property_name": "Jabriya Villas Complex",
		"property_code": "JVC-001",
		"owner_index": 0,
		"property_type": "Residential",
		"address": "Block 11, Jabriya",
		"city": "Jabriya",
		"final_status": "Under Maintenance",
	},
	{
		"property_name": "Al-Rai Warehouse Park",
		"property_code": "AWP-001",
		"owner_index": 2,
		"property_type": "Warehouse",
		"address": "Industrial Zone, Al-Rai",
		"city": "Al-Rai",
...
UNITS = [
	...
	# ── Gulf Commercial Center (2 units) ─────────────
	...
	# ── Jabriya Villas Complex (3 units) ─────────────
...
#  0=ANT101(Rented)  1=ANT102(Rented)  2=ANT201(Reserved)
...
TENANTS = [
	{"customer_name": "Mohammed Al-Osaimi",         "customer_type": "Individual", "civil_id": "298101234560", "tenant_type": "Individual"},   # 0
	{"customer_name": "Fatima Al-Ajmi",              "customer_type": "Individual", "civil_id": "295081234561", "tenant_type": "Individual"},   # 1
	{"customer_name": "Kuwait Tech Solutions W.L.L.","customer_type": "Company",    "civil_id": "",             "tenant_type": "Corporate"},    # 2
	{"customer_name": "Nasser Al-Shammari",          "customer_type": "Individual", "civil_id": "291041234562", "tenant_type": "Individual"},   # 3
	{"customer_name": "Gulf Trading Co.",            "customer_type": "Company",    "civil_id": "",             "tenant_type": "Corporate"},    # 4
	{"customer_name": "Layla Al-Kandari",            "customer_type": "Individual", "civil_id": "300021234563", "tenant_type": "Individual"},   # 5
	{"customer_name": "Ali Al-Enezi",                "customer_type": "Individual", "civil_id": "297071234564", "tenant_type": "Individual"},   # 6
	{"customer_name": "Pearls Import & Export",      "customer_type": "Company",    "civil_id": "",             "tenant_type": "Corporate"},    # 7
	{"customer_name": "Hessa Al-Fahad",              "customer_type": "Individual", "civil_id": "302031234565", "tenant_type": "Individual"},   # 8
	{"customer_name": "Blue Sky Logistics",          "customer_type": "Company",    "civil_id": "",             "tenant_type": "Corporate"},    # 9
]
